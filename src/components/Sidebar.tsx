...
const Sidebar: React.FC<SidebarProps> = ({ currentSection }) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-[30vw] min-w-[320px] bg-transparent p-6 flex flex-col justify-between" style={{zIndex: 10}}>
      <div className="pl-16">
        {/* Profile Picture */}
        <div className="flex flex-col items-center mb-8 mt-12 relative" style={{marginTop: '20px'}}>
        ...
        <div className="mb-6" style={{marginTop: '10px'}}>
          ...
          <button
            onClick={() => window.open('https://drive.google.com/file/d/1YvcjrFxJHk6EH1VouLGam7_pzL7KyXbU/view?usp=sharing', '_blank')}
